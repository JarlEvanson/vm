...
const MAX_PHYSICAL_ADDRESS_SHIFT: u32 = 40;

const PRESENT_SHIFT: u32 = 0;
const PRESENT_BIT: u32 = 1 << PRESENT_SHIFT;

const WRITABLE_SHIFT: u32 = 1;
const WRITABLE_BIT: u32 = 1 << WRITABLE_SHIFT;

const USER_SHIFT: u32 = 2;
const USER_BIT: u32 = 1 << USER_SHIFT;

const PWT_SHIFT: u32 = 3;
const PWT_BIT: u32 = 1 << PWT_SHIFT;

const PCD_SHIFT: u32 = 4;
const PCD_BIT: u32 = 1 << PCD_SHIFT;

const ACCESSED_SHIFT: u32 = 5;
const ACCESSED_BIT: u32 = 1 << ACCESSED_SHIFT;
...
const TABLE_ADDRESS_MASK: u32 = ((1 << TABLE_ADDRESS_MASK_SIZE) - 1) << TABLE_ADDRESS_MASK_SHIFT;

const TABLE_IGNORED_MASK: u32 = ((1 << 4) - 1) << 8;

// Block-related constants.
const BLOCK_SHIFT: u32 = 7;
const BLOCK_BIT: u32 = 1 << BLOCK_SHIFT;

const BLOCK_PAT_SHIFT: u32 = 12;
const BLOCK_PAT_BIT: u32 = 1 << BLOCK_PAT_SHIFT;

const BLOCK_LOWER_ADDRESS_MASK_SHIFT: u32 = 22;
const BLOCK_LOWER_ADDRESS_MASK_SIZE: u32 =
    MAX_PHYSICAL_ADDRESS_SHIFT - BLOCK_LOWER_ADDRESS_MASK_SHIFT;
const BLOCK_LOWER_ADDRESS_MASK: u32 =
    ((1 << BLOCK_LOWER_ADDRESS_MASK_SIZE) - 1) << BLOCK_LOWER_ADDRESS_MASK_SHIFT;

const BLOCK_UPPER_ADDRESS_MASK_SHIFT: u32 = 13;
const BLOCK_UPPER_ADDRESS_MASK_SIZE: u32 = 8;
const BLOCK_UPPER_ADDRESS_MASK: u32 =
    ((1 << BLOCK_UPPER_ADDRESS_MASK_SIZE) - 1) << BLOCK_UPPER_ADDRESS_MASK_SHIFT;

// Page-related constants.
const PAGE_PAT_SHIFT: u32 = 7;
const PAGE_PAT_BIT: u32 = 1 << PAGE_PAT_SHIFT;

const PAGE_ADDRESS_MASK_SHIFT: u32 = 12;
const PAGE_ADDRESS_MASK_SIZE: u32 = MAX_PHYSICAL_ADDRESS_SHIFT - PAGE_ADDRESS_MASK_SHIFT;
const PAGE_ADDRESS_MASK: u32 = ((1 << PAGE_ADDRESS_MASK_SIZE) - 1) << PAGE_ADDRESS_MASK_SHIFT;

// Page-or-block-related constants.
const PAGE_OR_BLOCK_DIRTY_SHIFT: u32 = 6;
const PAGE_OR_BLOCK_DIRTY_BIT: u32 = 1 << PAGE_OR_BLOCK_DIRTY_SHIFT;

const PAGE_OR_BLOCK_GLOBAL_SHIFT: u32 = 8;
const PAGE_OR_BLOCK_GLOBAL_BIT: u32 = 1 << PAGE_OR_BLOCK_GLOBAL_SHIFT;

const PAGE_OR_BLOCK_IGNORED_MASK: u32 = ((1 << 3) - 1) << 9;
...
impl TranslationDescriptor {
    ...
    pub const fn set_block_address(self, address: u64) -> Self {
        ...
        Self(
            non_address_bits
                | (address as u32 & BLOCK_LOWER_ADDRESS_MASK)
                | ((address >> (32 - BLOCK_UPPER_ADDRESS_MASK_SHIFT)) as u32),
        )
    }
