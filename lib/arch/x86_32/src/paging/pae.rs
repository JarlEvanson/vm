...
const TABLE_ADDRESS_SHIFT: u32 = 12;
const TABLE_ADDRESS_SIZE: u32 = MAX_PHYSICAL_ADDRESS_SHIFT - TABLE_ADDRESS_SHIFT;
const TABLE_ADDRESS_MASK: u64 = ((1 << TABLE_ADDRESS_SIZE) - 1) << TABLE_ADDRESS_SHIFT;

const TABLE_IGNORED_MASK: u64 = ((1 << 4) - 1) << 8;
...
const BLOCK_ADDRESS_SHIFT: u32 = 21;
const BLOCK_ADDRESS_SIZE: u32 = MAX_PHYSICAL_ADDRESS_SHIFT - BLOCK_ADDRESS_SHIFT;
const BLOCK_ADDRESS_MASK: u64 = ((1 << BLOCK_ADDRESS_SIZE) - 1) << BLOCK_ADDRESS_SHIFT;

const BLOCK_RESERVED_MASK: u64 = (((1 << 7) - 1) << 13) | (((1 << 11) - 1) << 52);
...
const PAGE_OR_BLOCK_IGNORED_MASK: u64 = ((1 << 3) - 1) << 9;

// Page-or-table-related constants.
const PAGE_OR_TABLE_RESERVED_MASK: u64 = ((1 << 11) - 1) << 52;

const PDPTE_RESERVED_MASK: u64 =
