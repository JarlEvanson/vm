//! The specification of the `i686` specific table.

pub use I686TableV0 as I686Table;

/// Table providing information and functionality that is specific to `i686`.
#[repr(C)]
#[derive(Clone, Copy, Debug, Hash, PartialEq, Eq)]
pub struct I686TableV0 {
    /// The version of the [`I686Table`] with which this table identifies.
    pub version: u64,
...
impl I686TableV0 {
    /// The version of the [`I686Table`] with which this [`I686Table`] is associated.
