...
pub struct GenericTableV0 {
    ...
    /// The total number of CPUs available on the system and that can be virtualized.
    pub cpu_count: u64,
...
impl MapFlags {
    ...
    /// The mapping function should choose the virtual location of the mapping (it should ignore
    /// the value of `virtual_address`.
