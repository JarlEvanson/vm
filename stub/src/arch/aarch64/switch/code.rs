...
use crate::{
    arch::{
        aarch64::switch::{ArchCodeLayout, CallStorage, CpuStorage, ModeStorage, arch_policy},
        generic::{
            memory::paging::{
...
pub fn allocate_code(
    ...
    if !write_u64_at(
        ...
        panic!("failed to write own mode storage pointer");
    }
    ...
    if !write_u64_at(
        ...
        panic!("failed to write other mode storage pointer");
    }
