//! Implementation of ELF relocation primitives for `i686` and `x86_64`.
...
/// Handles the ELF relocation types on `i686` and `x86_64`.
///
/// # Errors
///
...
/// Returns the size of the addend for an ELF relocation type on `i686` or `x86_64`.
///
/// # Errors
///
