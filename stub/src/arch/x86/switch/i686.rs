//! Implementation of cross-address space switching functionality for `i686`.
...
core::arch::global_asm! {
    ...
    ".equ own_mode_i686_offset, 4b - 5b",
    ".equ other_mode_i686_offset, 3b - 5b",
    ...
    "mov ecx, [ecx + own_mode_i686_offset]",
    ...
    "call get_base",
    "mov ebp, [ecx + own_mode_i686_offset]",
    "mov ecx, [ecx]",
    ...
    "call get_base",
    "mov esp, [ecx + other_mode_i686_offset]",
    "mov ebp, [ecx + own_mode_i686_offset]",
    "mov edi, [ecx]",
