...
/// # Safety
///
/// The [`Frame`]s contained within the provided [`FrameRange`] must have been allocated by a call
/// to [`allocate_frames()`] or [`allocate_frames_aligned()`] and must not be utilized after this
/// function.
